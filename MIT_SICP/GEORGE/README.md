## George Assignment
- Read George.pdf and I made code for these question.
- This assignment provides some skeleton codes.
***
1. Geroge's line.txt
```
#lang racket
...
(send frame show #t)
```
Using these code draw George, fish and triangle.
